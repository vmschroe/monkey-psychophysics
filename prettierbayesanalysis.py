...
plot_attr_dist_with_hdi(PSE_samples_ld, "Distracted", PSE_samples_ln, "Not Distracted", "Left Hand PSE")
plot_attr_dist_with_hdi(PSE_samples_rd, "Distracted", PSE_samples_rn, "Not Distracted", "Right Hand PSE")
plot_attr_dist_with_hdi(JND_samples_ld, "Distracted", JND_samples_ln, "Not Distracted", "Left Hand JND")
plot_attr_dist_with_hdi(JND_samples_rd, "Distracted", JND_samples_rn, "Not Distracted", "Right Hand JND")

plot_attr_dist_with_hdi(param_samps_ld[0], "Distracted", param_samps_ln[0], "Not Distracted", "Left Hand Gamma (guess rate)")
